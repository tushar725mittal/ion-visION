class BankModel{
  var items = [
    BankInfo(
      icon: "https://upload.wikimedia.org/wikipedia/en/5/58/State_Bank_of_India_logo.svg",
    ...
    BankInfo(
      icon: "https://brandeps.com/logo-download/K/Kotak-Mahindra-Bank-logo-vector-01.svg",
